...
//         }, // makes copy of all car values but change features. pull state&spread, car&spread, features&spread, keep features & add action.payload(object add/removed)
//         additionalFeatures: state.additionalFeatures.filter(
//           (feature) => feature.id !== action.payload.id
//         ), // if action do not match then
//         additionalPrice: state.additionalPrice + action.payload.price, // or do the for-loop in Total $$$$
//       };
//     case REMOVE_FEATURE:
//       return {
//         ...state,
...
//           ),
//         },
//         // complete opposite of add - remove features from features=[] and adding the rest to new array
